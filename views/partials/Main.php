<body>
  ...
  <li><a href="/Purchases" class="nav-link<?= urlis('/Purchases') ? ' active' : '' ?>"><i class="bi bi-cart4 me-2"></i>Purchases</a></li>
  <li><a href="/Sales" class="nav-link<?= urlis('/Sales') ? ' active' : '' ?>"><i class="bi bi-graph-up-arrow me-2"></i>Sales</a></li>
  ...
  <li><a href="/Accounts" class="nav-link<?= urlis('/Accounts') ? ' active' : '' ?>"><i class="bi bi-currency-exchange me-2"></i>Accounts</a></li>
